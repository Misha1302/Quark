...
public readonly struct VmValue
{
    ...
    public static VmValue Create<T>(T value, VmValueType type) where T : unmanaged
    {
    ...
    /// <returns>New Vmvalue instance</returns>
    public static VmValue CreateRef<T>(T value, VmValueType type) where T : class => new(value, type);
